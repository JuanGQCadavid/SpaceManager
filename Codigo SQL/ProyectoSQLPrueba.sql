...
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Direccion` (
  `idDireccion` VARCHAR(57) NOT NULL COMMENT 'ID = idOrgCreador + _$_ + idOrgContador + _#_ + contSede',
  `idCiudad` INT NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Perfil_Usuario` (`idUsuario` INT, `claveUsuario` INT, `nombreUsuario` INT, `Descripcion` INT, `telefonoCelular` INT, `correoElectronico` INT, `idRedesSociales` INT, `idPrivacidad` INT, `estadoUsuario` INT, `fechaCreacion` INT, `MostrarCorreo` INT, `MostrarOrgPertenece` INT, `MostrarOrgPropias` INT, `MostrarRedesSociales` INT, `MostrarTelefono` INT, `FaceBook` INT, `Twitter` INT, `Linkedin` INT, `Instagram` INT, `Google` INT);

-- -----------------------------------------------------
-- Placeholder table for view `SpaceAdmind`.`Org_administradores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Org_administradores` (`'Usuario Creador'` INT, `'Contador'` INT, `Encargado` INT, `Sede` INT, `Bloque` INT, `Nivel` INT, `'Identificador'` INT);
...
select Usuario.*,PrivacidadUsuario.MostrarCorreo,PrivacidadUsuario.MostrarOrgPertenece,
		PrivacidadUsuario.MostrarOrgPropias,PrivacidadUsuario.MostrarRedesSociales,
        PrivacidadUsuario.MostrarTelefono,RedesSociales.FaceBook,RedesSociales.Twitter,
        RedesSociales.Linkedin,RedesSociales.Instagram,RedesSociales.Google
...
select organizacion.idUsuarioCreador as 'Usuario Creador', organizacion.consecutivoOrg as 'Contador', sede.idUsuarioEncargado as Encargado,
	true as Sede, true as Bloque, true as Nivel,
...
select sede.idOrgUsuarioCreador as 'Usuario Creador', sede.idOrgContador as 'Contador', bloque.idUsuarioEncargado as Encargado,
	false as Sede, true as Bloque, true as Nivel,
...
select bloque.idOrgCreador as 'Usuario Creador', bloque.idOrgConsecutivo as 'Contador', nivel.idUsuarioEncargado as Encargado,
	false as Sede, false as Bloque, true as Nivel,
