...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Org_Administradores` (`'Usuario Creador'` INT, `'Contador'` INT, `Encargado` INT, `Jefe` INT, `Sede` INT, `Bloque` INT, `Nivel` INT, `'Identificador'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `SpaceAdmind`.`reservas_Mias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`reservas_Mias` (`'Usuario ID'` INT, `Organizacion` INT, `Sede` INT, `Bloque` INT, `Nivel` INT, `Espacio` INT, `Estado` INT);
...
select organizacion.idUsuarioCreador as 'Usuario Creador', 
...
select sede.idOrgUsuarioCreador as 'Usuario Creador', 
...
select bloque.idOrgCreador as 'Usuario Creador', 
