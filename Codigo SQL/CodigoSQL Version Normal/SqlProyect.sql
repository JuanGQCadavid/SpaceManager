...
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Organizacion` (
  ...
  `numero_Sedes` SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Bloque` (
  ...
  INDEX `idBloqueOrgCreador_idx` (`idOrgCreador` ASC, `idOrgConsecutivo` ASC),
  CONSTRAINT `idBloqueSedeId`
    FOREIGN KEY (`idSede`)
    REFERENCES `SpaceAdmind`.`Sede` (`idSede`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `idBloqueUserEncargado`
    FOREIGN KEY (`idUsuarioEncargado`)
    REFERENCES `SpaceAdmind`.`OrgUsuario` (`idOrgUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `idBloqueOrgCreador`
    FOREIGN KEY (`idOrgCreador` , `idOrgConsecutivo`)
    REFERENCES `SpaceAdmind`.`Organizacion` (`idUsuarioCreador` , `consecutivoOrg`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Nivel` (
  ...
  INDEX `idSede_idx` (`idSede` ASC),
  INDEX `idOrg_idx` (`idOrgCreador` ASC, `idOrgConsecutivo` ASC),
...
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Espacio` (
  ...
  INDEX `idBloque_idx` (`idBloque` ASC),
  INDEX `idSede_idx` (`idSede` ASC),
  INDEX `idOrg_idx` (`idOrgCreador` ASC, `idOrgContador` ASC),
  ...
  CONSTRAINT `idSedeEspacio`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `idOrgCreadorEspacio`
...
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`Reserva` (
  ...
  PRIMARY KEY (`idReserva`, `idEspacio`, `idNivel`, `idBloque`, `idSede`, `idOrgCreador`, `idOrgConsecutivo`),
  INDEX `idDiasHabiles_idx` (`idDiasReserva` ASC),
  INDEX `idUsuario_idx` (`idUsuario` ASC),
  INDEX `idEspaciosPk_idx` (`idEspacio` ASC),
  INDEX `idNivelReserva_idx` (`idNivel` ASC),
  INDEX `idBloqueReserva_idx` (`idBloque` ASC),
  INDEX `idSedeReserva_idx` (`idSede` ASC),
  INDEX `idOrgReserva_idx` (`idOrgCreador` ASC, `idOrgConsecutivo` ASC),
...
CREATE TABLE IF NOT EXISTS `SpaceAdmind`.`HorarioSede` (
  ...
  INDEX `idHorarioOrgUser_idx` (`idOrgUsuarioCreador` ASC, `idOrgContador` ASC),
