...
class Nivel(object):
	...
	def __init__(self, idNivel= None, idBloque= None, idSede= None, idOrgCreador= None, idOrgConsecutivo= None, numeroNivel= None, idUsuarioEncargado= None, idEspacioPublico= None, descripcionNivel= None, fechaCreacion= None):
