...
class Espacio(object):
	...
	def __init__(self, idEspacio= None, idNivel= None, idBloque= None, idSede= None, idOrgCreador= None, idOrgContador= None, idPermiso= None, capacidadEspacio= None, descripcionEspaco= None, nomenclaturaEspecial= None, fechaCreacion= None):
		...
		self.nomenclaturaEspecial = nomenclaturaEspecial 
	...
	#Getters y Setters de nomenclaturaEspecial

	def getNomenclaturaEspecial(self):
		return self.nomenclaturaEspecial
	def setNomenclaturaEspecial(self,nomenclaturaEspecial):
		self.nomenclaturaEspecial = nomenclaturaEspecial
