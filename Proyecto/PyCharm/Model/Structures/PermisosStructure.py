...
class Permisos(object):
	...
	def __init__(self, idPermisos= None, boss= None, p_Reserva= None, p_Nivel= None, p_Bloque= None, p_Sede= None, p_Org= None, pC_B= None, pC_S= None, pC_N= None, pC_E= None, p_Encargado= None):
